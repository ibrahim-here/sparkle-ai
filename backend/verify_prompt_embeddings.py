...
# Configuration
CHROMA_DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "chroma_db_prompt_engineering")
COLLECTION_NAME = "prompt_engineering_concepts"

def test_embeddings():
    print("--- STARTING PROMPT ENGINEERING EMBEDDINGS VERIFICATION ---")
    try:
        ...
        # Test Query
        sample_text = "How to write a clear prompt?"
